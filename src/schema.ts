...
import { DEFAULT_FOCUS_SETTINGS, DIFF_STYLES, MD_STYLES, TRANSCRIPT_VIEW_MODES, type FocusSettings } from './settings.ts'
...
export const FocusSettingsSchema: z<FocusSettings> = z.object({
  ...
  transcriptView: z.union([...TRANSCRIPT_VIEW_MODES]).default(DEFAULT_FOCUS_SETTINGS.transcriptView),
})
