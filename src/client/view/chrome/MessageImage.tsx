/** The official chat's message-image rendering (MessageImage/ImageGallery),
 *  reimplemented here because the attachment plugin no longer exports the
 *  components and the image slot is owned by the chat view's declaration. */
...
/** One gallery entry: a durable admitted reference, or a submission echo's
 *  local preview (a browser-owned object URL, already displayable). */
...
function singleFit(dimensions: { readonly width: number; readonly height: number }): { width: number; height: number; objectPosition: string } {
...
/** Intrinsic dimensions of one gallery entry; a preview's stay unknown until
 *  its intake probe resolved. */
