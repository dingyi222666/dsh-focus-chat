...
export const en = {
  ...
  'presented.expandAria': 'Expand all {count} delivered files',
  'presented.collapse': 'Collapse',
  'presented.collapseAria': 'Collapse the delivered-file list',
  ...
  'presented.revealed': 'Asked the file manager to show it',
  'presented.directoryOpening': 'Opening the containing folder…',
  'presented.directoryOpened': 'Asked to open the containing folder',
  'presented.error': 'Could not open; click to retry',
  'presented.revealError': 'Could not show in file manager. Try again.',
  'presented.directoryError': 'Could not open the containing folder. Try again.',
  'presented.nativeUnavailable': 'This file has no available Host path. Preview it in the sidebar.',
  'presented.unavailable': 'This host has no desktop available; files and folders cannot be opened',
  'presented.hostError': 'Could not read the host desktop information',
  'presented.retry': 'Retry',
  'presented.file': 'File',
  'presented.open': 'Open {name} in the default app',
  'image.label': 'Image',
