...
export const zh = {
  ...
  'duration.days': '{days} 天 {hours} 小时 {minutes} 分 {seconds} 秒',
  'tool.input': '输入',
  'tool.output': '输出',
  ...
  'workflow.run.title': '{name}',
  'workflow.members.one': '{count} 个成员',
  'workflow.members.other': '{count} 个成员',
  'workflow.run.empty': '没有启动成员',
  'workflow.phase.unassigned': '未分阶段',
  'workflow.phase.empty': '空阶段名',
  'workflow.statusCount.running': '运行中 {count}',
  'workflow.statusCount.completed': '已完成 {count}',
  'workflow.statusCount.failed': '失败 {count}',
  'workflow.statusCount.cancelled': '已取消 {count}',
  'workflow.statusCount.interrupted': '已中断 {count}',
  'workflow.member.empty': '空成员名',
  'workflow.member.open': '打开 {name}',
  ...
  'cordis.row.defineTitle': '注册 Cordis 插件',
  'cordis.row.runTitle': '运行 Cordis 插件',
  'cordis.row.updateTitle': '更新 Cordis 插件',
  'cordis.row.stopTitle': '停止 Cordis 插件',
  'cordis.row.removeTitle': '移除 Cordis 插件',
  'cordis.purpose.missing': '(未填写用途)',
  'cordis.status.idle': '待激活',
  'cordis.status.awaitingApproval': '待审批',
  'cordis.status.failed': '运行失败',
  'cordis.status.clientPending': 'Client 待激活',
  'cordis.status.running': '运行中',
  'cordis.status.removed': '已移除',
  'cordis.status.superseded': '已有更新',
  'cordis.run.removed': '包已不存在',
  'cordis.run.superseded': '已有更新的运行卡片，请查看下方',
  'cordis.panel.hint': '运行控制在左下角设置上方的 Cordis 面板',
  'cordis.action.inspect': '查看',
  'cordis.a11y.defining': '正在定义插件',
  'cordis.a11y.failed': '定义失败',
  'cordis.a11y.stopped': '定义已中断',
  'cordis.body.source': '插件代码',
  'cordis.body.hostCode': 'Host',
  'cordis.body.clientCode': 'Client',
  'cordis.body.output': '结果',
  'cordis.body.copy': '复制',
  'cordis.body.copied': '已复制',
  ...
  'presented.retry': '重试',
  'presented.file': '文件',
  'presented.row.running': '正在交付',
  'presented.row.ok': '已交付',
  'presented.row.error': '交付失败',
  'presented.row.stopped': '已中断',
  'image.label': '图片',
  ...
  'feedback.category.service-stability': '稳定性和速度',
...
export const en = {
  ...
  'duration.days': '{days} day {hours}h {minutes}m {seconds}s',
  'tool.input': 'IN',
  'tool.output': 'OUT',
  'tool.title.grep': 'Grep',
  'tool.title.glob': 'Glob',
  ...
  'workflow.run.empty': 'No members started',
  'workflow.phase.unassigned': 'Unphased',
  'workflow.phase.empty': 'Empty phase name',
  'workflow.statusCount.running': 'Running {count}',
  'workflow.statusCount.completed': 'Completed {count}',
  'workflow.statusCount.failed': 'Failed {count}',
  'workflow.statusCount.cancelled': 'Cancelled {count}',
  'workflow.statusCount.interrupted': 'Interrupted {count}',
  'workflow.member.empty': 'Empty member name',
  'workflow.member.open': 'Open {name}',
  ...
  'cordis.row.defineTitle': 'Register Cordis Plugin',
  'cordis.row.runTitle': 'Run Cordis Plugin',
  'cordis.row.updateTitle': 'Update Cordis Plugin',
  'cordis.row.stopTitle': 'Stop Cordis Plugin',
  'cordis.row.removeTitle': 'Remove Cordis Plugin',
  'cordis.purpose.missing': '(no purpose given)',
  'cordis.status.idle': 'Ready',
  'cordis.status.awaitingApproval': 'Awaiting approval',
  'cordis.status.failed': 'Run failed',
  'cordis.status.clientPending': 'Client ready to activate',
  'cordis.status.running': 'Running',
  'cordis.status.removed': 'Removed',
  'cordis.status.superseded': 'Newer run available',
  'cordis.run.removed': 'This package no longer exists',
  'cordis.run.superseded': 'A newer run card is available below',
  'cordis.panel.hint': 'Run controls live in the Cordis panel above Settings',
  'cordis.action.inspect': 'Inspect',
  'cordis.a11y.defining': 'Defining the plugin',
  'cordis.a11y.failed': 'Definition failed',
  'cordis.a11y.stopped': 'Definition interrupted',
  'cordis.body.source': 'Plugin source',
  'cordis.body.hostCode': 'Host',
  'cordis.body.clientCode': 'Client',
  'cordis.body.output': 'Result',
  'cordis.body.copy': 'Copy',
  'cordis.body.copied': 'Copied',
  ...
  'presented.file': 'File',
  'presented.row.running': 'Delivering',
  'presented.row.ok': 'Delivered',
  'presented.row.error': 'Delivery failed',
  'presented.row.stopped': 'Interrupted',
  'image.label': 'Image',
  ...
  'feedback.category.service-stability': 'Stability and speed',
