...
export const zh = {
  ...
  'tool.subagents': '启动了 {n} 个子代理',
  'tool.subagents.one': '启动了 {n} 个子代理',
  'tool.todos': '更新了 {n} 个待办',
  'tool.todos.one': '更新了 {n} 个待办',
  'tool.goals': '更新了 {n} 个目标',
  'tool.goals.one': '更新了 {n} 个目标',
...
export const en = {
  ...
  'tool.subagents': 'launched {n} subagents',
  'tool.subagents.one': 'launched {n} subagent',
  'tool.todos': 'updated {n} todos',
  'tool.todos.one': 'updated {n} todo',
  'tool.goals': 'updated {n} goals',
  'tool.goals.one': 'updated {n} goal',
