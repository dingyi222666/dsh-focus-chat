      ...
      if (previousItem !== undefined && previousItem.kind === 'tools') {
        ...
        const merged: FocusToolGroup = {
          ...
          metrics: {
            ...
            webSearches: prev.metrics.webSearches + folded.metrics.webSearches,
            fetches: prev.metrics.fetches + folded.metrics.fetches,
            ...
            webSearchesFailed: prev.metrics.webSearchesFailed + folded.metrics.webSearchesFailed,
          },
