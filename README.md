...
| Off — the normal chat view | On — the focus chat view | Settings |
| --- | --- | --- |
| ![Off: the normal chat view](screenshots/before.png) | ![On: the focus chat view](screenshots/after.png) | ![Focus chat settings](screenshots/settings.png) |
